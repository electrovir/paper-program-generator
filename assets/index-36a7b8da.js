 ...
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const ln={ATTRIBUTE:1,CHILD:2,PROPERTY:3,BOOLEAN_ATTRIBUTE:4,EVENT:5,ELEMENT:6},Xe=t=>(...e)=>({_$litDirective$:t,values:e});class et{constructor(e){}get _$AU(){return this._$AM._$AU}_$AT(e,r,n){this._$Ct=e,this._$AM=r,this._$Ci=n}_$AS(e,r){return this.update(e,r)}update(e,r){return this.render(...r)}}/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */const cn=Xe(class extends et{constructor(t){var e;if(super(t),t.type!==ln.ATTRIBUTE||t.name!=="class"||((e=t.strings)==null?void 0:e.length)>2)throw Error("`classMap()` can only be used in the `class` attribute and must be the only part in the attribute.")}render(t){return" "+Object.keys(t).filter(e=>t[e]).join(" ")+" "}update(t,[e]){var n,i;if(this.st===void 0){this.st=new Set,t.strings!==void 0&&(this.nt=new Set(t.strings.join(" ").split(/\s/).filter(a=>a!=="")));for(const a in e)e[a]&&!((n=this.nt)!=null&&n.has(a))&&this.st.add(a);return this.render(e)}const r=t.element.classList;for(const a of this.st)a in e||(r.remove(a),this.st.delete(a));for(const a in e){const s=!!e[a];s===this.st.has(a)||(i=this.nt)!=null&&i.has(a)||(s?(r.add(a),this.st.add(a)):(r.remove(a),this.st.delete(a)))}return oe}});/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */class zr extends et{constructor(e){if(super(e),this.it=O,e.type!==ln.CHILD)throw Error(this.constructor.directiveName+"() can only be used in child bindings")}render(e){if(e===O||e==null)return this._t=void 0,this.it=e;if(e===oe)return e;if(typeof e!="string")throw Error(this.constructor.directiveName+"() called with a non-string value");if(e===this.it)return this._t;this.it=e;const r=[e];return r.raw=r,this._t={_$litType$:this.constructor.resultType,strings:r,values:[]}}}zr.directiveName="unsafeHTML",zr.resultType=1;const bf=Xe(zr);/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
...
`,U=Mt()({tagName:"vira-icon",hostClasses:{"vira-icon-fit-container":({inputs:t})=>!!t.fitContainer},styles:({hostClasses:t})=>v`
    ...
    `,events:{expandChange:W()},stateInitStatic:{contentHeight:0},renderCallback({state:t,updateState:e,dispatch:r,events:n,inputs:i}){const a=i.expanded?v`
        ...
        `}});const $=tt({"vira-icon-stroke-color":"currentColor","vira-icon-fill-color":"none","vira-icon-stroke-width":"1px"});function le({name:t,svgTemplate:e}){return{name:t,svgTemplate:e}}const ol=le({name:"CloseX24Icon",svgTemplate:p`
...
`,ll=le({name:"LoaderAnimated24Icon",svgTemplate:p`
    ...
    `});var Qt;(function(t){t.Loading="loading",t.Error="error"})(Qt||(Qt={}));const ut=Mt()({tagName:"vira-image",hostClasses:{"vira-image-height-constrained":({inputs:t})=>t.dominantDimension==="height"},events:{imageLoad:W(),imageError:W()},styles:({hostClasses:t})=>v`
        :host {
            display: inline-flex;
            overflow: hidden;
            flex-direction: column;
    ...
    `,stateInitStatic:{loadedUrls:{},erroredUrls:{}},renderCallback({inputs:t,state:e,updateState:r,dispatch:n,events:i}){const a=t.imageUrl,s=e.erroredUrls[a]?p`
        ...
        `}});function gh(t,e){return t===dt.Password&&e?dt.Default:t||dt.Default}const wh=0;function yh(t){return!(t.type!=="click"||t.metaKey||t.altKey||t.ctrlKey||t.shiftKey||t.button!==wh)}globalThis.SPA_ROUTER_VIR_HISTORY_EVENTS_CONSOLIDATED_ALREADY=!1;var ds;(function(t){t.Upper="upper",t.Lower="lower"})(ds||(ds={}));var fs;(function(t){t.FirstThenWait="first-then-wait",t.AfterWait="after-wait"})(fs||(fs={}));function vh(){return globalThis.crypto?globalThis.crypto:require("crypto").webcrypto}vh();Mt()({tagName:"vira-link",cssVars:{"vira-link-hover-color":"currentColor"},styles:({cssVars:t})=>v`
        :host {
            display: inline;
    ...
    `,stateInitStatic:{inputElement:void 0},renderCallback({inputs:t,dispatch:e,events:r,state:n,updateState:i}){return n.inputElement&&n.inputElement.checked!==t.checked&&(n.inputElement.checked=t.checked),p`
        ...
        `}});function Vm(t){if(new Set(t).size!==t.length)throw new Error("Duplicate options found.")}const vs=C()({tagName:"vir-agenda-settings",renderCallback({inputs:t,dispatch:e}){function r(n){const i=x(t.agendaConfig);n(i)!==!1&&e(new Et(i))}return p`
            <${z.assign({label:"Paper fill",options:Ye(ge),value:t.agendaConfig.paperFill})}
    ...
    `,renderCallback({inputs:t}){return p`
        ...
        `}});var ot=(t=>(t.Edit="edit",t.Raw="raw",t.Templates="templates",t.Settings="settings",t))(ot||{});const Sr=C()({tagName:"vir-editor-tabs",styles:v`
        :host {
            display: flex;
        }
    `,events:{tabChange:W()},renderCallback({inputs:t,events:e,dispatch:r}){return Ye(ot).map(i=>p`
    ...
    `,renderCallback({inputs:t,dispatch:e}){return p`
            ...
            <div class="bottom-config">
                <${z.assign({label:"subtitle size",options:Ye(F),value:t.section.subtitleSize})}
    ...
    `,renderCallback({inputs:t,dispatch:e}){return p`
            <${z.assign({label:"align",options:Ye(vt),value:t.section.alignment})}
                ${w(z.events.valueChange,r=>{const n=x(t.section),i=r.detail;rr(i,vt)&&(n.alignment=i,e(new D(n)))})}
            ></${z}>
    ...
    `,renderCallback({inputs:t,dispatch:e,events:r}){const n=jm[t.section.sectionType],i={section:t.section},a="size"in t.section?p`
                      <${z.assign({label:"size",options:Ye(F),value:t.section.size})}
    ...
    `,renderCallback({inputs:t,dispatch:e}){function r(i){const a=x(t.agendaConfig);i(a),e(new Et(a))}return t.agendaConfig.pages.length?t.agendaConfig.pages.map((i,a)=>{const s=i.sections.map((o,l)=>p`
                ...
                <section class="page-editor">
                    ...
                    <div class="page-controls">
                        ...
                        ></${N}>
                        <${z.assign({label:"spacing",options:Ye(Xt),value:i.spacing})}
            ...
            `}):(r(i=>{i.pages.push(x(ai.defaultValue))}),O)}}),ht=C()({tagName:"vir-raw-json-editor",styles:v`
        :host {
            display: flex;
            flex-direction: column;
            gap: 16px;
    ...
    `,stateInitStatic:{textAreaElement:void 0,inputJson:""},renderCallback({inputs:t,state:e,updateState:r,dispatch:n}){const i=e.inputJson||JSON.stringify(t.agendaConfig,null,4),a=ac({jsonString:i,errorHandler(){return{}}}),s=Nr(()=>Zt(a,qe));return p`
            <textarea
                .value=${i}
    ...
    `,stateInitStatic:{currentEditorTab:ot.Edit},renderCallback({inputs:t,state:e,updateState:r}){const n=e.currentEditorTab===ot.Edit?p`
                      <${$s.assign({agendaConfig:t.agendaConfig})}></${$s}>
                  `:e.currentEditorTab===ot.Raw?p`
                        <${ht.assign({agendaConfig:t.agendaConfig})}></${ht}>
                    `:e.currentEditorTab===ot.Settings?p`
            ...
            ></${Sr}>
            ${n}
        `}}),hi={"vir-font-h1":48,"vir-font-h2":40,"vir-font-h3":32,"vir-font-h4":27,"vir-font-h5":24,"vir-font-h6":20,"vir-font-regular":20,"vir-font-small":16,"vir-font-tiny":14},ue=tt(pi(hi,(t,e)=>`${e}px`));function Gm(t){const e=j(hi).map(r=>{const n=hi[r]*t;return`${ue[r].name}: ${n}px;`});return de(e.join(`
`))}const Zr=C()({tagName:"vir-font",hostClasses:{"vir-font-h1":({inputs:t})=>t.size===F.H1,"vir-font-h2":({inputs:t})=>t.size===F.H2,"vir-font-h3":({inputs:t})=>t.size===F.H3,"vir-font-h4":({inputs:t})=>t.size===F.H4,"vir-font-h5":({inputs:t})=>t.size===F.H5,"vir-font-h6":({inputs:t})=>t.size===F.H6,"vir-font-regular":({inputs:t})=>t.size===F.Regular,"vir-font-small":({inputs:t})=>t.size===F.Small,"vir-font-tiny":({inputs:t})=>t.size===F.Tiny},styles:({hostClasses:t})=>v`
    ...
    `,renderCallback({inputs:t}){const e=t.section.rows.map(r=>{const n=r.map(i=>{const a=qr(i.text);return i.isHeader?p`
        ...
        `}}),Jm=C()({tagName:"vir-text-present",hostClasses:{"vir-text-present-left":({inputs:t})=>t.section.alignment===vt.Left,"vir-text-present-justify":({inputs:t})=>t.section.alignment===vt.Justify},styles:({hostClasses:t})=>v`
        :host {
            display: block;
            text-align: center;
        }
    ...
    `,stateInitStatic:{agendaConfig:ns({defaultValue:ws(Pe.AgendaConfig)}),userAgendaTemplates:ns({defaultValue:ws(Pe.AgendaTemplates).then(t=>I(t,"array")?t.filter(r=>Jn(r,si)):[])})},renderCallback({state:t,inputs:e}){if((t.agendaConfig.value==null||as(t.agendaConfig.value))&&t.agendaConfig.setValue(e.defaultAgendaConfig),is(t.agendaConfig.value)){if(!Jn(t.agendaConfig.value,qe)){const i=Nr(()=>Zt(t.agendaConfig.value,qe));console.error(i);const a=p`
            ...
            `;return p`
                <div class="fix-error-editor">
                    <${Gr}>${a}</${Gr}>
                    <${ht.assign({agendaConfig:t.agendaConfig.value})}
